...
VL_ATTR_COLD void VRegister_file_tb___024root___eval_static__TOP(VRegister_file_tb___024root* vlSelf) {
    ...
    // Body
    vlSelf->Register_file_tb__DOT__pass_count = 0U;
    vlSelf->Register_file_tb__DOT__fail_count = 0U;
}
...
#endif
            VL_FATAL_MT("testbench/Register_file_tb.sv", 3, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void VRegister_file_tb___024root___ctor_var_reset(VRegister_file_tb___024root* vlSelf) {
    ...
    vlSelf->Register_file_tb__DOT__rst_n = VL_RAND_RESET_I(1);
    vlSelf->Register_file_tb__DOT__rs1_data = VL_RAND_RESET_I(32);
    vlSelf->Register_file_tb__DOT__rs1_addr = VL_RAND_RESET_I(5);
    vlSelf->Register_file_tb__DOT__rs2_data = VL_RAND_RESET_I(32);
    vlSelf->Register_file_tb__DOT__rs2_addr = VL_RAND_RESET_I(5);
    vlSelf->Register_file_tb__DOT__write_data = VL_RAND_RESET_I(32);
    vlSelf->Register_file_tb__DOT__write_addr = VL_RAND_RESET_I(5);
    vlSelf->Register_file_tb__DOT__write_enable = VL_RAND_RESET_I(1);
    vlSelf->Register_file_tb__DOT__pass_count = 0;
    vlSelf->Register_file_tb__DOT__fail_count = 0;
    for (int __Vi0 = 0; __Vi0 < 32; ++__Vi0) {
        vlSelf->Register_file_tb__DOT__dut__DOT__register[__Vi0] = VL_RAND_RESET_I(32);
    }
    vlSelf->__Vdlyvval__Register_file_tb__DOT__clk__v0 = VL_RAND_RESET_I(1);
    vlSelf->__Vdlyvset__Register_file_tb__DOT__clk__v0 = 0;
