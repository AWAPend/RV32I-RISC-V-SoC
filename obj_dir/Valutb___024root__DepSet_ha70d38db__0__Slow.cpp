...
#endif  // VL_DEBUG
VL_ATTR_COLD bool Valutb___024root___eval_phase__stl(Valutb___024root* vlSelf);
...
#endif
            VL_FATAL_MT("testbench/ALU_tb.sv", 3, "", "Settle region did not converge.");
        }
        __VstlIterCount = ((IData)(1U) + __VstlIterCount);
        __VstlContinue = 0U;
        if (Valutb___024root___eval_phase__stl(vlSelf)) {
            __VstlContinue = 1U;
        }
...
VL_ATTR_COLD bool Valutb___024root___eval_phase__stl(Valutb___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Valutb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Valutb___024root___eval_phase__stl\n"); );
    // Init
...
VL_ATTR_COLD void Valutb___024root___ctor_var_reset(Valutb___024root* vlSelf) {
    ...
    // Body
    vlSelf->alutb__DOT__a = VL_RAND_RESET_I(32);
    vlSelf->alutb__DOT__b = VL_RAND_RESET_I(32);
    vlSelf->alutb__DOT__alu_select = VL_RAND_RESET_I(4);
    vlSelf->alutb__DOT__result = VL_RAND_RESET_I(32);
    }
