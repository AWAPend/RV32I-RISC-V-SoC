...
module Decoder_tb;
    ...
    //SLT
    localparam SLT_x11_x1_x2 = {7'b0, 5'b00010, 5'b00001, 3'b010, 5'd11, 7'b0110011};
    //SLTU
    localparam SLTU_x12_x1_x2 = {7'b0, 5'b00010, 5'b00001, 3'b011, 5'd12, 7'b0110011};

    //I-type: imm[12] | rs1[5] | funct3[3] | rd[5] | opcode[7]
    //ADDI, rd = x1 + 58
    localparam ADDI_x13_x1_58 = {12'd58, 5'b00001, 3'b000, 5'd13, 7'b0010011};
    //SLLI
    localparam SLLI_x14_x1_4 = {12'd4, 5'b00001, 3'b001, 5'd14, 7'b0010011};
    //SLTI
    ...
    localparam SRAI_x19_x2_2 = {12'd2, 5'b00010, 3'b101, 5'd19, 7'b0010011};
    //ORI
    ...
    initial begin
        ...
        //R-type
        check(ADD_x3_x1_x2, 5'd3, 32'd32, "ADD_x3_x1_x2");
        check(SUB_x4_x2_x1, 5'd4, 32'd10, "SUB_x4_x2_x1");
        check(AND_x5_x1_x2, 5'd5, (32'd11 & 32'd21), "AND_x5_x1_x2");
        check(OR_x6_x1_x2, 5'd6, (32'd11 | 32'd21), "OR_x6_x1_x2 ");
        check(XOR_x7_x1_x2, 5'd7, (32'd11 ^ 32'd21), "XOR_x7_x1_x2");
        check(SLL_x8_x1_x2, 5'd8, (32'd11 << 32'd21), "SLL_x8_x1_x2");
        check(SRL_x9_x1_x2, 5'd9, (32'd11 >> 32'd21), "SRL_x9_x1_x2");
        check(SRA_x10_x1_x2, 5'd10, $signed(32'd11 >> 32'd21), "SRA_x10_x1_x2");
        check(SLT_x11_x1_x2, 5'd11, 32'd1, "SLT_x11_x1_x2, x1 < x2 is true");
        check(SLTU_x12_x1_x2, 5'd12, 32'd1, "SLTU_x12_x1_x2, x1 < x2 is true");
